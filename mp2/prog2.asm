; Stack Calculator - SP22 MP2
; Binh-Minh Nguyen (bmn4)
; UIUC ECE220 MP2 2/2/2022

; Evaluates a reverse polish notation expression.
; Takes keyboard inputs, valid inputs are:
; 0-9 (can only take 1 digit inputs)
...
; ^ (exponentiate)
; = (equals)
; If there are not enough inputs for a function or the expression is not complete when = is enetered, "Invalid Expression" will be printed
